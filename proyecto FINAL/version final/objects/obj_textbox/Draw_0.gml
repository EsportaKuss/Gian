...
textbox_y = camera_get_view_y(view_camera[0]) + cam_size*0.75;
...
if setup == false
	...
	for(var p = 0; p < page_number; p++)
		...
		for (var c = 0; c < text_length[p]; c++) 
			...
			var _char_pos = c+1;
			var _txt_x = textbox_x + txt_x_offset[p] + (cam_size-textbox_width)/2;
...
if accept_key 
	...
	if draw_char == text_length[page]
	{
		if page < page_number-1
			...
			{
				script_rooms(global.room_to,obj_neco,70,230)
			}
...
//---------------------draw textbox------------------------	
var _txtb_x = textbox_x + (cam_size-textbox_width)/2; //previamente era + txt_x_offset[page]
...
if speaker_sprite[page] != noone 
	...
	//draw speaker
	draw_sprite_ext(sprite_index, image_index, _speaker_x + x_displacement_spr, _view_y + y_displacement_spr, speaker_side[page]*xscale_displacement_spr, 1*yscale_displacement_spr, 0, c_white, alpha);
