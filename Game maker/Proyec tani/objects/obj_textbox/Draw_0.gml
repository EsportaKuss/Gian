...
if speaker_sprite[page] != noone 
	...
	//draw speaker
	draw_sprite_ext(sprite_index, image_index, _speaker_x + x_displacement_spr, 0 + _view_y + y_displacement_spr, speaker_side[page]*xscale_displacement_spr, 1*yscale_displacement_spr, 0, c_white, alpha);
