...
//player interaction
if keyboard_check_pressed(ord("C")) && !instance_exists(obj_textbox) && global.animation == false {global.using_inventory = true;}
...
for (var i = 0; i < INVENTORY_SLOTS; i += 1){
	var xx = x + view_x + (i mod row_length) *36 + 2;
	var yy = y + view_y + (i div row_length) *36 + 2;
