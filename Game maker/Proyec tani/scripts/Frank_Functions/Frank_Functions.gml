...
function Frank_Jumping(){
	...
	if point_distance(x,y,337,320) < spd {spd = 0; with (obj_camera) {follow = obj_Frank;}}
	if image_index > 66 {image_speed = 0; with(obj_camera) {follow = obj_neco;} timer = 20; state = FRANKSTATE.PROJECTILE_1; }
}
